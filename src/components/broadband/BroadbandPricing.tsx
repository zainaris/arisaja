...
const plans: Plan[] = [
  {
    ...
    speed: "30 Mbps",
    price: "Rp 177.600",
    yearly: "Rp 1.776.600 /tahun",
    features: ["Unlimited Quota", "Free Router WiFi", "Support 24/7", "Instalasi Gratis"],
  },
  {
    name: "Basic",
    speed: "50 Mbps",
    price: "Rp 222.000",
    yearly: "Rp 2.222.000 /tahun",
    features: ["Unlimited Quota", "Dual Band Router", "Support 24/7", "Instalasi Gratis", "No FUP"],
  },
  {
    name: "Standard",
    speed: "75 Mbps",
    price: "Rp 266.400",
    yearly: "Rp 2.666.400 /tahun",
    features: ["Unlimited Quota", "Dual Band Router", "Support 24/7", "Instalasi Gratis", "No FUP", "Stabil & Simetris"],
    highlight: true,
    badge: "BEST VALUE",
  },
  {
    ...
    speed: "100 Mbps",
    price: "Rp 333.000",
    yearly: "Rp 3.333.000 /tahun",
    features: ["Unlimited Quota", "Priority Support", "Instalasi Gratis", "No FUP", "Stabil & Simetris"],
  },
  {
    name: "Ultra",
    speed: "200 Mbps",
    price: "Rp 466.200",
    yearly: "Rp 4.666.200 /tahun",
    features: ["Dedicated 1:1", "Enterprise Router", "Priority Support", "Static IP", "Stabil & Simetris"],
  },
];
...
const PricingCard = ({ plan }: { plan: Plan }) => (
  <div
    className={`relative rounded-2xl p-8 transition-all duration-300 flex flex-col ${
      plan.highlight
        ? "bg-primary text-primary-foreground shadow-xl scale-[1.03] border-2 border-primary z-10"
        : "bg-card text-card-foreground shadow-card hover:shadow-card-hover border-2 border-transparent hover:border-primary/30"
    }`}
  >
    {plan.badge && (
    ...
    <p className={`text-3xl font-extrabold mb-1 ${plan.highlight ? "text-primary-foreground" : "text-primary"}`}>
      {plan.speed}
    </p>
    ...
    <div className="my-4">
      <p className={`text-2xl font-bold ${plan.highlight ? "text-primary-foreground" : "text-foreground"}`}>
        {plan.price}
        <span className={`text-sm font-normal ${plan.highlight ? "text-primary-foreground/70" : "text-muted-foreground"}`}>
          {" "}/bulan
        </span>
      </p>
  ...
  <section id="pricing" className="py-20 lg:py-28 bg-secondary">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <h2 className="text-3xl lg:text-4xl font-bold text-foreground text-center mb-4">
        Pilih Paket Broadband <span className="text-primary">Sesuai Kebutuhan Anda</span>
      </h2>
      <p className="text-muted-foreground text-lg text-center max-w-2xl mx-auto mb-16">
        Semua paket termasuk instalasi gratis dan dukungan teknis 24/7
      </p>
