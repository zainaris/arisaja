...
const specs = ["Dedicated Bandwidth 1:1", "Available Speed: 20 Mbps – 10 Gbps", "International & IIX Route", "IPv4 & IPv6 Support", "BGP Ready", "Redundant Path Option", "Fiber Optic Backbone"];
    ...
    <section className="py-20 lg:py-28 bg-secondary">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl lg:text-4xl font-bold text-foreground text-center mb-4">
          {t("ded.specs.heading1")} <span className="text-primary">{t("ded.specs.heading2")}</span>
        </h2>
        <p className="text-muted-foreground text-lg text-center max-w-2xl mx-auto mb-16">{t("ded.specs.desc")}</p>
